...
if __name__ == '__main__':
    # block_traces = ["datasets/day_2/blocks/block_video.csv", "datasets/day_2/blocks/block_audio.csv"]
    # network_trace = "datasets/day_2/networks/traces_8.txt"
    ...
    # solution_file = 'solution_demos.reno.4-29'
