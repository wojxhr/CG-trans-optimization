...
class MySolution(BlockSelection, Reno):
    ...
    def __init__(self):
        ...
        self.instant_drop_nums_list = list([0] * EPISODE)
    ...
    def select_block(self, cur_time, block_queue):
        ...
        def is_better(block):
            ...
            #     return False
            # # all information
            if best_block_ddl_ratio * best_block_rest_ratio * P[
                best_block_priority] > block_ddl_radio * block_rest_ratio * P[cur_block_priority]:
                return True
            else:
                return False
    ...
    def cc_trigger(self, cur_time, event_info):
        ...
        if event_time < self.old_cwnd:
            ...
            self.last_congest_done_index=0
        ...
        if self.cur_time < event_time:
            ...
            self.last_cwnd = 0
            self.instant_drop_nums = 0
            self.instant_drop_nums_list.append(self.instant_drop_nums)
            self.instant_drop_nums_list.pop(0)
